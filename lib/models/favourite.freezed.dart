...
class _$FavouriteImpl implements _Favourite {
  ...
  @override
  String toString() {
    return 'Favourite(id: $id, userId: $userId, movieId: $movieId, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, movieId, createdAt, updatedAt);
...
abstract class _Favourite implements Favourite {
  const factory _Favourite(
      ...
      required final DateTime updatedAt}) = _$FavouriteImpl;
